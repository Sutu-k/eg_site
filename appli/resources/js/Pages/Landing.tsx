                        ...
                        {projects.map((project, index) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                                    ...
                                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 flex space-x-4">
                                        {/* Bouton "Voir détails" */}
                                        ...
                                        {project.url && (
                                            <a
                                                ...
                                                className="text-eg-tertiary text-sm font-medium flex items-center"
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-lg transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="flex items-center text-white/80">
                                        <span className="inline-block w-8 text-[#C0CF3A] mr-[10px]">+224</span> 
                                         625 35 77 27
                                    </p>
