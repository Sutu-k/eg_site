...
const EGLayout: React.FC<EGLayoutProps> = ({ title, children }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            {/* Pied de page */}
            <footer className="bg-[#455F51] text-white">
                        ...
                        <div>
                            ...
                            <ul className="mt-4 space-y-2">
                                <li className="flex items-start">
                                    ...
                                    <span className="ml-2 text-sm text-white/80">Conakry, Guinée</span>
                                </li>
                                <li className="flex items-start">
                                    <svg className="h-5 w-5 text-eg-secondary mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <span className="ml-2 text-sm text-white/80">oumar.camara@efficienceglobale.com</span>
                                </li>
                                <li className="flex items-start">
                                    <svg className="h-5 w-5 text-eg-secondary mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                    </svg>
                                    <span className="ml-2 text-sm text-white/80">+224 625 35 77 27</span>
                                </li>
                            </ul>
                        </div>
                    </div>
